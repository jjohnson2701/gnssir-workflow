"""
Daily Diagnostics Tab for Enhanced GNSS-IR Dashboard v3
======================================================
...
def display_annual_polar_plots(station_id, year):
    ...
    st.success(f"✓ Displaying {len(available_plots)}/3 polar analysis plots")
...
def render_diagnostics_tab(station_id="FORA", year=2024, data_dict=None):
    ...
    st.header("🔍 Diagnostics - Quality Analysis")
